  ...
  <div class="col-lg-12">
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
      <div class="form-group">
        ...
        <select class="form-control select2" name="vndrnm" id="vndrnm">
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
      <div class="form-group">
        ...
        <select class="form-control select2" name="prjct_name" id="prjct_name">
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
      <div class="form-group">
        ...
        <select class="form-control select2" name="jobodr_num" id="jobodr_num">
